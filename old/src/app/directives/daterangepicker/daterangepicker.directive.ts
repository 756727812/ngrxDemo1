...
/* tslint:disable one-variable-per-declaration ter-prefer-arrow-callback no-var-keyword */

dateRangePicker.$inject = [
  '$compile',
  '$timeout',
  '$parse',

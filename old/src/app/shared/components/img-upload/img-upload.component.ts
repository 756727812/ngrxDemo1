...
// 自定义验证器
export function seeImgUploadValidator(status: string): ValidatorFn {
...
const VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => SeeImgUploadComponent),
  multi: true,
};

@Component({
  selector: 'see-img-upload',
  templateUrl: 'img-upload.component.html',
  styleUrls: ['img-upload.component.less'],
  providers: [VALUE_ACCESSOR],
})
export class SeeImgUploadComponent implements OnInit, ControlValueAccessor {

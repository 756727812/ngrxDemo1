...
@Component({
  selector: 'app-event-kol-selector-v2',
  templateUrl: './kol-selector-v2.component.html',
  styleUrls: ['./kol-selector-v2.component.less'],
})
export class EventKolSelectorV2Component implements OnInit {

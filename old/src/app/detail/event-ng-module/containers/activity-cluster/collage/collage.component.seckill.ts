...
@Component({
  selector: 'app-marketing-seckill',
  templateUrl: './collage.component.html',
  styleUrls: ['./collage.component.less'],
})
export class MarketingSeckillComponent implements OnInit {
  ...
  // 表单
  _activityType = '';
  activityTypes = [{ value: '-1', label: '秒杀' }];
  _activityStatus;
  activityStatuss = [
    { value: '1', label: '待开始' },
    { value: '2', label: '进行中' },
  ...
  _keywordChild = '';
  params = {
    activityType: '2', // 1-拼团 2-秒杀 3-满减  默认值1
    page: 1,
    pageSize: 10,
  }; // 查询参数

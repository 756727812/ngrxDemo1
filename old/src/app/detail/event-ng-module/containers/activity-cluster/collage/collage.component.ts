...
export class CollageComponent implements OnInit {
  ...
  // 没有全选了
  // get hasSelectedAll() {
  //   return this.cookieService.get('seller_privilege') === '7';
  // }
  checkedMap = {};
  ...
  _keywordChild = '';
  params = {
    activityType: '1', // 1-拼团 2-秒杀 3-满减  默认值1
    page: 1,
    pageSize: 10,
  }; // 查询参数
  ...
  //       (value.activityStatus!=='3' && value.activityStatus!=='4')||
  //         this.checkedMap[index]
  //     );
  //   const allUnChecked = this.data.every(
  //     (value, index) =>
  ...
  //         ||!this.checkedMap[index]
  //   );
  //   this._disabledButton = !this.data.some((value,index) => this.checkedMap[index]);
  //   this._allChecked = allChecked;
  //   this._indeterminate = !allChecked && !allUnChecked;
  //   console.log(this.checkedMap);
  // }

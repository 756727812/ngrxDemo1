...
export interface IReportService {
  report: (page_id: number, content_id: number, module_id: number, opt_id: number) => void
  reportByPageModuleKey: (pageKey: string, moduleKey: string) => void
  reportByPageKey: (pageKey: string, extOptions?: { ext1?: string, ext2?: string, ext3?: string }) => void
  reportByKey: (key: string, extOptions?: { ext1?: string, ext2?: string, ext3?: string }) => void
}

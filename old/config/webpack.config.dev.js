...
module.exports = {
    ...
    rules: [
      {
        ...
        oneOf: [
          ...
          },
          {
            ...
            // 注意：这里的 @ngtools/webpack 不会做类型检查
  ...
  plugins: [
    new ForkTsCheckerWebpackPlugin({
      ...
      // watch: [paths.appIndexJs, paths.appMainTs, paths.appSrcCode],
      watch: [paths.appMainTs, paths.appSrcCode],
    }),
    ...
    new AngularCompilerPlugin({
      ...
      hostReplacementPaths: {
        'environments/environment.ts': paths.environments,
      },
      sourceMap: false,
      tsConfigPath: paths.tsAppConfig,
